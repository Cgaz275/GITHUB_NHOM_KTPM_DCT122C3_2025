...
├── modules/auth         (feature branches)
├── modules/catalog
├── modules/checkout
├── modules/cms
├── modules/customer
├── modules/oms
└── feature/task-name    (short-lived branches)
```

### Development Process

```
Create Branch → Make Changes → Run Tests → Push → Create PR
    ↓            ↓               ↓          ↓      ↓
...
- **Members**: Đào Thị Thanh Tâm, Dương Lê Khánh
...
3. ✅ Read [WORKFLOW.md](./WORKFLOW.md) for development process
